...
# 设置显示界面的位置
try:
    fig.canvas.manager.window.wm_geometry("+120+110")
except AttributeError:
    pass  # Handle the case where the backend does not support window positioning
...
def init():
    ...
    ax.set_yticks(())
    ax.set_xlabel(
        "frequency ( * " + str(frequency_threshold / bin_nums) + " Hz)")
...
if __name__ == "__main__":
    # 设置音乐文件的路径
    # audio_path = '炫酷城市节奏音频律动音乐可视化效果AE模板.m4a'
